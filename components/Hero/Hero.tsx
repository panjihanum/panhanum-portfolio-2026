      ...
      >
        ...
        <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-4">
          ...
          <Paragraph className="text-slate-300 text-base md:text-lg max-w-xl">
            I’m a Software Engineer with 5+ years experience in full-stack development, specializing in Java Spring Boot, React, and modern web technologies. Passionate about scalable systems, API integration, and performance optimization.
          </Paragraph>
          <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start items-center mt-2">
            <Button asChild variant="outline" className="border-sky-400 text-sky-400 hover:bg-sky-400/10 flex items-center gap-2 shadow-lg">
              <a href="mailto:panhanum.dev@gmail.com"><FaEnvelope className="text-lg" /> panhanum.dev@gmail.com</a>
            </Button>
            <Button asChild variant="outline" className="border-sky-400 text-sky-400 hover:bg-sky-400/10 flex items-center gap-2 shadow-lg">
              <a href="tel:+6282113589617"><FaPhone className="text-lg" /> +62 821-1358-9617</a>
            </Button>
          </div>
          <div className="text-slate-400 text-sm mt-2">Jakarta Timur, DKI Jakarta, 13930</div>
        </div>
      </motion.div>
      <ScrollDownButton />
    </section>
