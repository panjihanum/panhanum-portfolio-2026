                    ...
                    {skillGroups.map((group) => (
                        ...
                        >
                            <div className="flex items-center gap-2 mb-2">
                                ...
                                <span className="bg-slate-700/40 text-xs text-slate-300 px-2 py-0.5 rounded-full font-semibold">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                {group.skills.map((skill) => (
                                    ...
                                    >
                                        ...
                                        <span className="text-slate-200 text-xs font-semibold text-center mt-2">
                                            {skill.name}
                                        </span>
                                    </motion.div>
                                ))}
