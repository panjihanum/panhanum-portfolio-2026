...
export default function About() {
    return (
        <section id="about" className="w-full flex justify-center items-center py-20 px-4 bg-[#232532] border-t border-[#232532]/60">
            <motion.div
            ...
            >
                ...
                <div className="flex-1 flex flex-col items-center md:items-start text-center md:text-left gap-6">
                    <Heading className="text-white text-3xl md:text-4xl font-bold mb-2">About Me</Heading>
                    <Paragraph className="text-slate-300 text-base md:text-lg">
                        Hi! I’m Panji Hanum, a passionate Full-stack Developer with 5+ years of experience. I love building scalable, high-performance web applications and solving complex problems with clean code. My expertise covers Java Spring Boot, React, Next.js, API integration, and modern web technologies. I enjoy collaborating in teams, optimizing performance, and delivering impactful digital solutions.
                    </Paragraph>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-4 w-full">
                        <div className="flex flex-col items-center gap-2 bg-sky-900/30 rounded-xl p-4">
                            ...
                            <span className="text-sky-200 text-xs font-semibold">Full-stack Dev</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 bg-fuchsia-900/30 rounded-xl p-4">
                            ...
                            <span className="text-fuchsia-100 text-xs font-semibold">API Integration</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 bg-emerald-900/30 rounded-xl p-4">
                            ...
                            <span className="text-emerald-100 text-xs font-semibold">Performance</span>
                        </div>
                        <div className="flex flex-col items-center gap-2 bg-yellow-900/30 rounded-xl p-4">
                            <FaUsers className="text-yellow-200 text-2xl" />
                            <span className="text-yellow-100 text-xs font-semibold">Collaboration</span>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="text-slate-200 text-lg font-semibold text-center">Years Experience</div>
